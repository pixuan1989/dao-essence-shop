...
function getFallbackProducts() {
  return [
    ...
    },
    {
      ...
      "currency": "USD",
      "description": "Five Elements digital energy guidance program with personalized audio guide, energy assessment tools, and daily practice routines.",
      "descriptionCN": "五行数字能量指引课程，含个性化音频指南、能量评估工具及日常练习套餐。",
