...
- **内容要求：描述"状态/趋势"，不写具体事件，也不写万能废话**
  - 事业：写执行状态（如"执行顺畅，宜推进" / "阻力暗生，宜暂缓" / "易生变数，需灵活"）
  - 财运：写资金状态（如"支出略增，需把控" / "资金流动频繁，宜留心" / "宜静不宜动"）
  - 感情：写情绪/沟通状态（如"沟通顺畅，宜表达" / "情绪易躁，宜忍耐" / "需防误会"）
  - 健康：写体感状态（如"易感疲乏，宜早睡" / "气机浮躁，宜静心" / "注意肠胃"）
- **根据干支关系调整措辞，保持差异化**：
  - 六合：多用"顺遂""得利""宜进取"
  - 相冲：多用"阻滞""变动""宜守成"
  - 相害：多用"暗耗""纠结""宜内省"
