...
## 禁用词清单（绝对禁止出现，每条都是 AI 模板话术）
- "火势过旺反生滞碍" / "火势过旺" / "三午火叠见" / "午火过旺"
- "午后宜静坐调息" / "午后小憩" / "午后宜静坐"
- "贵人暗中提携" / "贵人暗助" / "贵人明透"
- "诸事顺势而为" / "气机畅达"
- "整体宜守不宜攻" / "宜以稳为先"
...
- **内容必须具体，严禁通用套话**：
  - 运势好时写具体利好（如"利签约""得长辈提携""宜拓展客源"）
  - 运势差时写具体风险（如"防合同陷阱""忌借贷""易生口舌是非"）
  - **禁止使用"正财平稳""人缘佳""身体无碍"等万能废话**
- **禁止口语化**——不说"你明天会被拉进项目组""朋友间会吵架"这种大白话
- 可以用常用命理词：吉凶参半、贵人、劫财、相冲、相害、六合、执行力
- **禁止**使用深度学术术语：正官、七杀、比肩、伤官、食神、伏吟、透出、得令、当令、润局等
- **禁止**解释性话术："火旺则木焚""因为 XX 所以 XX"
- 语气果断直接，不绕弯子
- 不要讲故事，不要生活化场景开头
- 一段或两段即可，不要分条列举
