...
## 禁用词清单（绝对禁止出现）
- **通用套话**："正财平稳" / "人缘佳" / "身体无碍" / "偏财勿贪" / "有劫财迹象"
- **具体事件**："资质申领" / "报销到账" / "左膝痛" / "合同陷阱" / "资金调度"
- **AI 模板**："火势过旺" / "贵人暗助" / "诸事顺势" / "气机畅达" / "午后静坐"
- 以上词语为常见 AI 模板话术或过度具体/过度通用的废话，**绝对禁止出现**

## 写作风格（不二堂风格）
- **第一句开门见山**："生肖${name}今日运势[吉凶参半/平稳/下降/上升]，[核心判断]"
- **全文 80-120 字**，精炼有力，不注水
- **语言风格：大白话 + 具体观察（这是不二堂的核心）**
  - **禁止**使用文言/文学修辞（如"财气聚于近处"、"言语温厚"、"气机舒展"）。
  - **必须**使用**具体的身体/情绪/行为描述**（如"容易有胃肠道不适"、"身体方面有讨厌油腻的状态"、"容易闹脾气"、"身上淤青多"、"精力充沛"）。
  - **必须**包含**现代/具体场景**（如"朋友圈比较活跃"、"可能会因为家人朋友而花钱"、"适合出门游玩"、"有享受美食的计划"、"旧情人纠缠"）。
  - **混合词汇**：使用不二堂常用词（如"烂桃花"、"小人运强旺"、"贵人运"、"奔波之象"、"冲犯日建"、"劫财的迹象"）。
- **内容要求**：
  - **具体建议**：给出具体动作（如"需要穿红色衣饰化解"、"不可冷战"、"适合运动出汗"、"远离久违联系的朋友"、"宜明哲保身"）。
  - **点名特定人群**：偶尔点名特定人群（如"中年女性"、"营销人员"、"男性容易被旧情人纠缠"、"有伴侣者"）。
- **禁止**解释原理（如"火旺则..."），**禁止**编造"明日发生事件"（如"明天你会捡到钱"），只写"今日适宜/不宜/容易/有迹象"。
- 一段即可，不要分条列举。
