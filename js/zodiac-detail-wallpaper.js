...
(function() {
  ...
  async function init() {
    const grid = document.getElementById('zodiac-detail-wp-grid');
    if (!grid) return;
    ...
    try {
      ...
      picks.forEach(wp => {
        ...
        a.style.cssText = "display:block;width:100px;border-radius:8px;overflow:hidden;border:1px solid rgba(255,255,255,0.1);transition:transform 0.2s;";
