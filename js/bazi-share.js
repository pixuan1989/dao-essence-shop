...
(function() {
  ...
  var css = [
    ...
    '.bazi-share-item img{width:22px;height:22px;flex-shrink:0;pointer-events:none;filter:invert(38%) sepia(64%) saturate(450%) hue-rotate(5deg) brightness(90%) contrast(90%)}',
