---
title: "Five Elements Body Type: What BaZi & TCM Reveal About Your Health"
...
imageAlt: "Five human silhouettes in Wood Fire Earth Metal Water poses with corresponding organs highlighted"
...
faq:
  - question: "What are the Five Elements body types?"
...
keywords: "five elements body type, bazi health constitution, TCM body constitution, five elements health, wood fire earth metal water body type, bazi health prediction, five elements wellness, 五行体质, 八字健康, 中医体质"
---
...
<table class="self-test-table" style="width:100%;border-collapse:collapse;margin:1.5rem 0;font-size:0.95rem;">
<thead>
<tr style="background:#D4AF37;color:#1a1a2e;">
<th style="padding:10px;border:1px solid #c9a837;text-align:left;">Feature</th>
<th style="padding:10px;border:1px solid #c9a837;">Wood</th>
<th style="padding:10px;border:1px solid #c9a837;">Fire</th>
<th style="padding:10px;border:1px solid #c9a837;">Earth</th>
<th style="padding:10px;border:1px solid #c9a837;">Metal</th>
<th style="padding:10px;border:1px solid #c9a837;">Water</th>
</tr>
</thead>
<tbody>
<tr><td style="padding:8px;border:1px solid #3a3a5c;">Tall, slim build</td><td style="padding:8px;border:1px solid #3a3a5c;text-align:center;">✓</td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td></tr>
<tr style="background:rgba(212,175,55,0.06);"><td style="padding:8px;border:1px solid #3a3a5c;">Pointed face, flushed skin</td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;text-align:center;">✓</td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td></tr>
<tr><td style="padding:8px;border:1px solid #3a3a5c;">Solid, round build</td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;text-align:center;">✓</td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td></tr>
<tr style="background:rgba(212,175,55,0.06);"><td style="padding:8px;border:1px solid #3a3a5c;">Square face, prominent bones</td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;text-align:center;">✓</td><td style="padding:8px;border:1px solid #3a3a5c;"></td></tr>
<tr><td style="padding:8px;border:1px solid #3a3a5c;">Soft, round body</td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;text-align:center;">✓</td></tr>
<tr style="background:rgba(212,175,55,0.06);"><td style="padding:8px;border:1px solid #3a3a5c;">Gets irritated under stress</td><td style="padding:8px;border:1px solid #3a3a5c;text-align:center;">✓</td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td></tr>
<tr><td style="padding:8px;border:1px solid #3a3a5c;">Burns out fast, anxious</td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;text-align:center;">✓</td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td></tr>
<tr style="background:rgba(212,175,55,0.06);"><td style="padding:8px;border:1px solid #3a3a5c;">Overthinks, worries</td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;text-align:center;">✓</td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td></tr>
<tr><td style="padding:8px;border:1px solid #3a3a5c;">Perfectionist, holds grudges</td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;text-align:center;">✓</td><td style="padding:8px;border:1px solid #3a3a5c;"></td></tr>
<tr style="background:rgba(212,175,55,0.06);"><td style="padding:8px;border:1px solid #3a3a5c;">Withdraws when stressed</td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;text-align:center;">✓</td></tr>
<tr><td style="padding:8px;border:1px solid #3a3a5c;">Headaches, eye strain</td><td style="padding:8px;border:1px solid #3a3a5c;text-align:center;">✓</td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td></tr>
<tr style="background:rgba(212,175,55,0.06);"><td style="padding:8px;border:1px solid #3a3a5c;">Heart palpitations, insomnia</td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;text-align:center;">✓</td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td></tr>
<tr><td style="padding:8px;border:1px solid #3a3a5c;">Bloating, fatigue after meals</td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;text-align:center;">✓</td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td></tr>
<tr style="background:rgba(212,175,55,0.06);"><td style="padding:8px;border:1px solid #3a3a5c;">Dry skin, constipation, allergies</td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;text-align:center;">✓</td><td style="padding:8px;border:1px solid #3a3a5c;"></td></tr>
<tr><td style="padding:8px;border:1px solid #3a3a5c;">Lower back pain, cold hands/feet</td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;"></td><td style="padding:8px;border:1px solid #3a3a5c;text-align:center;">✓</td></tr>
</tbody>
</table>
**Count your checks per column.** The highest score is likely your dominant body type. If it's close between two types, your BaZi chart can clarify which element is stronger.
...
1. **Self-awareness** — understanding why your body reacts the way it does
2. **Timing** — knowing which periods in your life are harder on your system (through luck cycles)
3. **Action** — specific dietary, lifestyle, and environmental adjustments that support your weak points
...
[Generate your free BaZi chart →](/#free-bazi)

---

<style>
.self-test-table th { background: #D4AF37 !important; color: #1a1a2e !important; padding: 10px; border: 1px solid #c9a837; }
.self-test-table td { padding: 8px; border: 1px solid #3a3a5c; text-align: center; }
.self-test-table td:first-child { text-align: left; }
</style>
