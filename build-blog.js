        ...
        <article class="blog-article">
            ...
            <div class="share-buttons">
                ...
                <button class="share-btn" data-platform="reddit" title="Share on Reddit">
                    <svg viewBox="0 0 24 24"><path d="M12 0A12 12 0 000 12a12 12 0 0012 12 12 12 0 0012-12A12 12 0 0012 0zm5.01 4.744c.688 0 1.25.561 1.25 1.249a1.25 1.25 0 01-2.498.056l-2.597-.547-.8 3.747c1.824.07 3.48.632 4.674 1.816.585.54.58 1.504.21 2.223-.623 1.508-2.144 2.54-4.17 2.54-1.813 0-3.373-1.084-3.86-2.556-.308-.755-.377-1.654.074-2.303.494-.744 1.517-1.282 2.675-1.456l.743-3.485-2.523-.547a1.25 1.25 0 01-.058-2.498 1.248 1.248 0 011.24 1.065l3.21.696a1.25 1.25 0 011.065-1.065l.696-3.21zm-5.01 6.49a1.25 1.25 0 110 2.5 1.25 1.25 0 010-2.5z"/></svg>
                </button>
                <button class="share-btn" data-platform="pinterest" title="Share on Pinterest">
                    <svg viewBox="0 0 24 24"><path d="M12 0C5.373 0 0 5.373 0 12c0 5.303 3.438 9.8 8.208 11.385.6.113.82-.26.82-.577 0-.285-.01-1.04-.015-2.04-3.338.711-4.042-1.415-4.042-1.415-.546-1.287-1.333-1.63-1.333-1.63-1.09-.73.083-.716.083-.716 1.205.082 1.838 1.215 1.838 1.215 1.07 1.753 2.807 1.246 3.492.952.108-.74.418-1.246.76-1.532-2.678-.296-5.488-1.288-5.488-5.74 0-1.27.462-2.31 1.22-3.125-.123-.298-.53-1.495.115-3.115 0 0 .995-.313 3.26 1.195.945-.257 1.96-.386 2.97-.39 1.01.004 2.025.133 2.97.39 2.26-1.508 3.255-1.195 3.255-1.195.645 1.62.24 2.817.12 3.115.758.815 1.22 1.855 1.22 3.125 0 4.465-2.815 5.44-5.505 5.73.432.366.823 1.088.823 2.192 0 1.583-.015 2.86-.015 3.25 0 .32.216.694.825.578C20.565 21.798 24 17.303 24 12c0-6.627-5.373-12-12-12z"/></svg>
                </button>
