...
async function sendSingleMail({ to, subject, htmlBody, textBody, fromAlias, tagName, replyToAddress }) {
    ...
    if (!accessKeyId || !accessSecret || !account) {
        throw new Error('阿里云邮件配置缺失（ALIYUN_ACCESS_KEY/ALIYUN_ACCESS_SECRET/ALIYUN_EMAIL_ACCOUNT）');
    }
    ...
    params.Signature = getAliyunSign(params, accessSecret);
